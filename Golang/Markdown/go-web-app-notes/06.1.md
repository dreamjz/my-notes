...
<center>图6.2 session的原理图</center>
...
<center>图6.3 浏览器端保存的cookie信息</center>
...
Golang通过net/http包中的SetCookie来设置Cookie
...
cookie:=http.Cookie{Name:"username",Value:"kesa",Expires:expiration}
